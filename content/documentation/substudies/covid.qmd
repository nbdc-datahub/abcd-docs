...
<!-- [Download table as a pdf](../../assets/files/documentation/substudies/6_1_covid.pdf){style="display: block; text-align: right; margin-top: 4px;"} -->
...
- `r full_cite("glynn2019")`
- `r full_cite("roenneberg2003")`
- `r full_cite("lee2011")`
...
`r table_header("covid_y_fitbqtn")`
...
`r table_header(tabulated = FALSE, file_based = TRUE)`
...
`r table_header("covid_l_geopolicy")`  
