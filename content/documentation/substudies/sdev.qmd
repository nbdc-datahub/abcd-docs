...
[**Age items error (6.0)**](../release_notes/6_0.qmd#known-issue-age-items): Age items in the Social Development substudy currently contain implausible values. Users should filter out unreasonably large values in these fields and can also compare the data to the _age variable provided for the table.

[**Non-response data error (6.0)**](../release_notes/6_0.qmd#known-issue-integer-fields-with-non-response-data): Some items were created in a way that asked participants to enter `98` or `99` to indicate either “Don’t know” or “Decline to answer.” Data users should recode `98` = “I don’t know” and `99` = “Decline to answer” for all integer variables in the substudy.
:::
