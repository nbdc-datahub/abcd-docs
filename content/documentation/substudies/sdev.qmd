...
<!-- [Download table as a pdf](../../assets/files/documentation/substudies/6_1_sdev.pdf){style="display: block; text-align: right; margin-top: 4px;"} -->
...
::: {.callout-caution collapse="true" title="Release notes: `Social Development`"}
**7.0**

[**New tables**](../release_notes/7_0.qmd#new-tables): Social Development substudy has the following new tables: Parental Incarceration [Parent], Gang Membership and Activity [Youth], Parental Incarceration [Youth], Police Interaction [Youth]
:::
...
::: {#use-sdev_y_rd .callout-important collapse="true" title="Responsible use consideration: Reported delinquency"}
...
::: {.callout-caution collapse="true" title="Release notes: `sdev_y_rd`"}
**7.0**

[**Age item outliers**](../release_notes/7_0.qmd#age-item-outliers) Age items in the Social Development substudy previously contained implausible values. These issues were corrected for the 7.0 release. New `__dk` items were created to store any non-missing responses to these items.

**6.0**

[**Age items error**](../release_notes/6_0.qmd#known-issue-age-items)

[**Non-response data error (6.0)**](../release_notes/6_0.qmd#known-issue-integer-fields-with-non-response-data)
:::
...
::: {.callout-caution collapse="true" title="Release notes: `sdev_y_fa`"}
**7.0**
...
## Gang Membership and Activity \[Youth\] {#sdev_y_gma}

`r table_header("sdev_y_gma")`

**Measure description:** The proposed items will address lifetime and current gang membership, age of onset, length of membership, and whether the participant took part in a variety of delinquent/criminal activities during that time. We are also in a unique position to investigate sex differences. Thus, we will also investigate whether participants have been involved in romantic relationships with a gang member and, as a consequence, been involved in gang criminal activity. 

**Key references:** 

- `r full_cite("melde2011")`
- `r full_cite("moore2001")`


## Parental Incarceration \[Youth\] {#sdev_y_incar}

`r table_header("sdev_y_incar")`

**Measure description:** Parental incarceration can have serious long-term consequences for children (@aaron2010). Over and above the direct risk that parental incarceration poses for increased delinquent behavior, there are also indirect risks such as economic and health consequences, and deterioration of family relationships (@arditti2015). Disrupted sleep patterns and unhealthy eating habits have been associated with both maternal and paternal incarceration (@jackson2017). Other results show direct associations between parental incarceration and three dimensions of health: general health behaviors, substance use, and other risky behaviors (@heard-garris2018; @wildeman2018). We have developed a short questionnaire adapted to the ABCD-SD study sample and added follow up questions about the circumstances around the incarceration and arrest. 

**Key references:** 

- `r full_cite("aaron2010")`
- `r full_cite("arditti2015")`
- `r full_cite("jackson2017")`
- `r full_cite("heard-garris2018")`
- `r full_cite("wildeman2018")`

## Police Interaction \[Youth\] {#sdev_y_pol}

`r table_header("sdev_y_pol")`

**Measure description:** Despite mixed evidence, early interactions with police and juvenile justice systems are risk factors for future delinquency or persistent behavior problems. Police interactions have been found to predict increased delinquency (@wiley2016) and violent behavior, especially for low-rate violent offenders (@ward2014). By measuring these interactions prospectively, we will investigate pathways to increasing involvement in and sanctions by the juvenile and criminal justice systems. Police and juvenile justice contacts will be measured using an adapted version of the Police Contact Questionnaire, developed by the Pittsburgh Youth Study team (@loeber2008). 

**Key references:** 

- `r full_cite("wiley2016")`
- `r full_cite("ward2014")`
- `r full_cite("loeber2008")`

## Victimization {#sdev_y_vict}

`r table_header("sdev_y_vict")`  
...
::: {.callout-caution collapse="true" title="Release notes: `sdev_y_vict`"}
**7.0**
...
## Parental Incarceration \[Parent\] {#sdev_p_incar}

`r table_header("sdev_p_incar")`
...
`r table_header("sdev_p_rd")`

**Measure description:** ABCD-SD uses a contemporary version of the Self-Reported Delinquency Scale (SRD) with co-offending added, and substance use, and sexual items. All measures were administered in all waves to date. At `ses-S01` all questions were asked from a lifetime perspective. From `ses-S02`, all relevant items were modified to reflect the time between the `ses-S01` assessment and the follow-up assessment.

Scales: vandalism; theft; violence; police contact

::: {#use-sdev_p_rd .callout-important collapse="true" title="Responsible use consideration: Reported delinquency"}
Statistical analyses of the Youth 10 Item Delinquency Scale revealed evidence of significant measurement bias across demographic groups and thus discontinued use/sharing of this measure. Unlike the main study, the ABCD-SD uses the full Self-Reported Delinquency Scale. We recommend conducting differential item functioning for this measure to determine whether there are biases before including it in your analyses as was done in @brislin2024.
::: 

::: {.callout-caution collapse="true" title="Release notes: `sdev_p_rd`"}
**7.0**
...
[**Non-response data error**](../release_notes/6_0.qmd#known-issue-integer-fields-with-non-response-data)
:::
