...
<!-- [Download table as a pdf](../../assets/files/documentation/substudies/6_1_mrs.pdf){style="display: block; text-align: right; margin-top: 4px;"} -->
...
- `r full_cite("prescot2013")`
- `r full_cite("schulte2006")`

## HERMES {#mrs_y_hermes}

`r table_header("mrs_y_hermes")`  
...
- `r full_cite("saleh2016")`
- `r full_cite("edden2014")`
