...
<!-- [Download table as a pdf](../../assets/files/documentation/substudies/6_1_ecb.pdf){style="display: block; text-align: right; margin-top: 4px;"} -->

# Youth table {#ecb_y_ecb}

`r table_header("ecb_y_ecb")`  
...
- `r full_cite("cedernaes2016")`
- `r full_cite("hanlon2015")`
- `r full_cite("heyman2012")`
- `r full_cite("monteleone2012")`
- `r full_cite("spagnolo2016")`
