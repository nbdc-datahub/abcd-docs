...
QSIRecon configures pipelines for reconstructing and modeling preprocessed diffusion-weighted MRI data. For more information see the [QSIRecon documentation](https://qsirecon.readthedocs.io/en/latest/). The following command was used to run ABCC subjects through QSIRecon reconstruction
