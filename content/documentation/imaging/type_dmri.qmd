...
library(dplyr)
library(stringr)
render_table_info_imaging("str_detect(sub_domain, 'Diffusion MRI')")
```

<!-- [Download table as a pdf](../../assets/files/documentation/imaging/6_1_mr_dti.pdf){style="display: block; text-align: right; margin-top: 4px;"} -->
...
- `r full_cite("dick2021")`
- `r full_cite("dudley2023")`
- `r full_cite("fortin2017")`
- `r full_cite("holland2010")`
- `r full_cite("palmer2022")`
