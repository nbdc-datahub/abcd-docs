...
[Download table as a pdf](../../assets/files/documentation/imaging/6_0_mr_y_tfmri.pdf){style="display: block; text-align: right; margin-top: 4px;"}
...
[**GE - Timing triggers (6.0)**](../release_notes/6_0.qmd#event-timing-offset-for-ge-scanners): There was previously a discrepancy in how stimulus times were modeled relative to the end of the calibration/dummy volumes in the image acquisition that affects GE scanners.
