...
## ABCD-BIDS Pipeline Derivatives {#abcd-bids-pipeline}
...
The QSIPrep pipeline is used for preprocessing the ABCD diffusion-weighted MRI (dMRI) data. Preprocessing includes head motion correction, susceptibility distortion correction, MP-PCA denoising, coregistration to T1w images, ANTS spatial normalization, and tissue segmentation. To see an explanation of the QSIPrep pipeline derivatives, please visit the section on [Outputs of QSIPrep](https://qsiprep.readthedocs.io/en/latest/preprocessing.html#outputs-of-qsiprep) in the QSIPrep documentation.
...
To see a detailed explanation of the QSIRecon pipeline derivatives and reconstruction specifications, please visit the section on [Outputs of QSIRecon](https://qsirecon.readthedocs.io/en/latest/outputs.html) in the QSIRecon documentation.
