...
# Domain overview
```{r}
render_table_info_imaging("sub_domain == 'Structural MRI'")
```

<!-- [Download table as a pdf](../../assets/files/documentation/imaging/6_1_mr_smri.pdf){style="display: block; text-align: right; margin-top: 4px;"} -->
...
**Key reference:** `r full_cite("hagler2019")`
