...
library(dplyr)
library(stringr)
render_table_info_imaging("str_detect(table_name, 'mr_y_adm')")
```

<!-- [Download table as a pdf](../../assets/files/documentation/imaging/6_1_mr_adm.pdf){style="display: block; text-align: right; margin-top: 4px;"} -->

# Youth tables 

## MRI Info {#mr_y_adm__info}

`r table_header("mr_y_adm__info")`
