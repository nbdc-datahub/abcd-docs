...
# Domain overview
```{r}
render_table_info_imaging("atlas == 'Behavior'")
```

<!-- [Download table as a pdf](../../assets/files/documentation/imaging/6_1_mr_tfmri_beh.pdf){style="display: block; text-align: right; margin-top: 4px;"} -->
...
::: {#use-taskfMRI .callout-important title="Responsible use consideration: Performance" collapse="true"}
...
`r table_header("mr_y_tfmri__mid__beh")`
...
`r table_header("mr_y_tfmri__mid__qtn")`
...
`r table_header("mr_y_tfmri__sst__beh")`
...
`r table_header("mr_y_tfmri__nback__beh")`
...
`r table_header("mr_y_tfmri__nback__rec")`
