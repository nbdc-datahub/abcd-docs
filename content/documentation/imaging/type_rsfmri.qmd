...
# Domain overview
```{r}
render_table_info_imaging("sub_domain == 'Resting State fMRI'")
```

<!-- [Download table as a pdf](../../assets/files/documentation/imaging/6_1_mr_rsfmri.pdf){style="display: block; text-align: right; margin-top: 4px;"} -->
...
::: {.callout-caution collapse="true" title="Release notes: rsfMRI Updates"}
**7.0**

-   [**rsfMRI updates**](../release_notes/7_0.qmd#rsfMRI):
...
*Preprocessing for concatenated data differences between 6.0 and 7.0*
...
::: {.callout-important collapse="true" title="Responsible use consideration: Head motion" #use-rsfmri}
...
::: {.callout-caution collapse="true" title="Release notes: `mr_y_rsfmri`"}
**6.0**

-   [**Column name correction**](../release_notes/6_0.qmd#column-misnaming-in-rsfmri-network-to-subcortical-roi-correlation-tabulated-data): Column names in the [`mr_y_rsfmri__corr__gpnet__aseg`](https://abcd.deapscience.com/?hierarchyOrder=%5B%22study%22%2C%22domain%22%2C%22subDomain%22%2C%22source%22%2C%22metric%22%2C%22atlas%22%5D&hierarchy=%5B%5B%22Youth%22%2C%22MRS+%28HERMES%29+%5BYouth%5D%22%5D%2C%5B%22Correlation%22%2C%22Resting+State+fMRI+-+Correlations+%28Gordon+network+to+Subcortical%29+%5BYouth%5D%22%5D%5D#/my-datasets/create-dataset) table—which contains tabulated imaging data representing rsfMRI correlations between cortical networks and subcortical ROIs—were corrected in the current release.
:::
...
Image processing and analysis methods corresponding to ABCD Release 2.0.1 are described in @hagler2019. Changes to image processing and analysis methods in prior releases are documented in [Imaging Overview Data Documentation](index.qmd). No significant changes were made to the processing pipeline for Release 5.0 or Release 6.0.
...
- `r full_cite("fair2007")`
- `r full_cite("holland2010")`
- `r full_cite("pruim2015")`
- `r full_cite("pruim2015a")`
- `r full_cite("ramduny2024")`
- `r full_cite("wells1996")`
