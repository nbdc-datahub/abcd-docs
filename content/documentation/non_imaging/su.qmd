...
<!-- [Download table as a pdf](../../assets/files/documentation/non_imaging/6_1_su.pdf){style="display: block; text-align: right; margin-top: 4px;"} -->
...
::: {.callout-caution collapse="true" title="Release notes: Substance use summary scores"}
**7.0** 

-   [**Substance use summary scores**](../release_notes/6_1.qmd#substance-use-summary-scores): New dynamic and static substance use (SU) summary scores have been introduced in the 7.0 Release to harmonize substance use indicators across multiple measures 
:::

::: {.callout-important collapse="true" title="Responsible use consideration: Word choice- drug use and addiction" #use-su}
...
Given the early first age of ABCD data collection, administration of toxicological assessments was randomized to small portions of the cohort, with the percentage tested growing over time, or those who endorsed substance use. Randomized oral fluid testing occurred at Baseline-Year 3, while Year 4 and 5 used urinalysis for all participants. Hair was collected at all timepoints from all participants who were willing and whose hairstyle would not be disrupted by collection, but only select samples underwent toxicological testing.

Beginning on 9/1/2024 (part of Year 6, Year 7, and all of Year 8), administration of toxicological matrices was changed to ensure testing of both acute substance use and a longer window of use. To achieve this, oral fluid testing was administered to all participants, as it gives a 12-48 hour window of detection for substances. Hair collection was also required, as it measures up to 3 months of substance use (excepting the first 8 days, as the hair takes >7 days to emerge from the scalp). If either oral fluid or hair samples were not able to be collected for any reason (e.g., missing supplies; too short of hair), urinalysis was required. This is because urine can detect recent use, as well as longer-term use (up to 1 month) in some drug classes in those who regularly use the drug.

### Alcohol Toxicology {#su_y_alctox}

`r table_header("su_y_alctox")`
...
::: {.callout-caution collapse="true" title="Release notes: `Hair Toxicology Results`"}
**7.0** 

-   [**Coding fix**](../release_notes/7_0.qmd#hair-toxicology-results-coding-fix): In the 6.0 and 6.1 release, some hair toxicology results were incorrectly coded as 1/2 instead of 0/1 for negative/positive, respectively. All results coding has been updated in the 7.0 release and users of 6.0 data should be aware of this issue.
:::

**Key references:**

- `r full_cite("wade2022")`
- `r full_cite("wade2023")`
- `r full_cite("haist2021")`

### Nicotine Toxicology {#su_y_nictox}

`r table_header("su_y_nictox")`
...
- `r full_cite("brown1987")`
- `r full_cite("greenbaum1995")`
- `r full_cite("stein2007")`

### Alcohol Hangover Symptoms {#su_y_alchss}

`r table_header("su_y_alchss")`
...
**Key references:** `r full_cite("slutske2003")`

### Alcohol Motives {#su_y_alcmot}

`r table_header("su_y_alcmot")`
...
- `r full_cite("cooper1994")`
- `r full_cite("grant2007")`
- `r full_cite("kuntsche2009")`

### Alcohol Problems {#su_y_alcprob}

`r table_header("su_y_alcprob")`
...
**Key reference:** `r full_cite("white1989")`

### Alcohol Subjective Effects {#su_y_alcsre}

`r table_header("su_y_alcsre")`
...
**Key reference:** `r full_cite("lewisesquerre2005")`

### Cigarette Use Motives {#su_y_cigmot data-link="Tobacco Motives"}

`r table_header("su_y_cigmot")`

**Measure description:** Motives for using cigarette products.

**Key reference:** `r full_cite("smith2010")`

### Community Risk and Protective Factors (Youth) {#su_y_crpf}

`r table_header("su_y_crpf")`
...
**Notes and special considerations:** Starting in Year 9, only availability of alcohol, nicotine (cigarettes and vaping), and cannabis were asked to reduce participant burden.

**Key references:**

- `r full_cite("arthur2007")`
- `r full_cite("trentacosta2011")`

### Drug Problems {#su_y_drgprob}

`r table_header("su_y_drgprob")`

**Measure description:** Symptom frequency checklist of "other" drug-related problems over past 6 months

**Key references:**

-   `r full_cite("johnson1989")`
-   `r full_cite("caldwell2002")`
-   `r full_cite("kingston2011")`

### Dynamic Substance Use Summary Scores {#su_y_dyn}

`r table_header("su_y_dyn")`

**Measure description:** Dynamic substance use (SU) summary scores were introduced starting in the 7.0 Release to harmonize substance use indicators across multiple measures (Substance Use Interview, TLFB, and Mid-Year Phone Interview; @lisdahl2018). Harmonizing across multiple measures has been shown to more comprehensively capture substance rates across the ABCD sample (@sullivan2022; Sullivan et al., Under Review). These dynamic scores (`su_y_dyn__`) summarize participant-by-event indicators of lifetime use across substances. These scores integrate information across instruments to generate consistent indicators of reported use and onset. Alcohol, Cannabis, and Nicotine use variables include composite variables of low-level use (i.e., sipping or puff), full standard use, or combined low and full use for each substance. Full substance use variables including low level use are indicated within the variable name (i.e., “lowuse”). Further, composite variables across all substance use are computed (i.e., `__su__`) as well as substance use other than alcohol, nicotine, or cannabis (i.e., `__su__oth__`).
...
- `r full_cite("pierce1996")`
- `r full_cite("strong2015")`

### KSADS---Alcohol Use Disorder (Youth) {#su_y_ksads__aud}

`r table_header("su_y_ksads__aud")`
...
**Notes and special considerations:** Youth KSADS was initiated after youth reported at least two alcohol use days. Gating was changed for Year 8 from two to at least five alcohol use days based on participant data and to lessen participant burden.
...
**Key reference:** `r full_cite("kaufman2021")`

### KSADS---Drug Use Disorder (Youth) {#su_y_ksads__dud}

`r table_header("su_y_ksads__dud")`

**Measure description:** DSM-5 based symptoms and diagnoses (although not clinician administered; therefore, not official psychiatric diagnoses) of drug use disorder based on the responses to individual questions using the computer administered version of the Kiddie Schedule for Affective Disorders and Schizophrenia for School-Aged Children ([KSADS-COMP](https://www.ksadslogin.net/ksads-comp/aboutKC.aspx)).

**Notes and special considerations:** Youth KSADS was initiated after youth reported at least two use days of any drug use. Gating was changed for Year 8 from two to at least five drug use days based on participant data and to lessen participant burden.
...
**Key reference:** `r full_cite("torrealday2008")`

::: {.callout-important collapse="true" title="Responsible use consideration: Marijuana expectancies (MEEQ-B)" #use-su_y_can_exp}
...
- `r full_cite("nccih2025")`
- `r full_cite("solomon2020")`
:::

### Marijuana Motives {#su_y_mjmot}

`r table_header("su_y_mjmot")`
...
- `r full_cite("lee2009")`
- `r full_cite("simons1998")`

### Marijuana Problems {#su_y_mjprob}

`r table_header("su_y_mjprob")`
...
- `r full_cite("pomerleau1998")`
- `r full_cite("rodriguez2004")`

### ENDS Expectancies {#su_y_nicvapeexp}

`r table_header("su_y_nicvapeexp")`
...
- `r full_cite("johnson2003")`
- `r full_cite("johnston2016")`

### Peer Deviance {#su_y_pgd}

`r table_header("su_y_pgd")`

**Measure description:** Measures friends' use of alcohol, nicotine, marijuana, inhalants, and "other" drugs.

**Key reference:** `r full_cite("freedman1988")`

::: {.callout-important collapse="true" title="Responsible use consideration: Peer deviant behavior" #use-su_y_peerdevia}
...
**Key reference:** `r full_cite("lisdahl2018")`

### Peer Tolerance {#su_y_ptu}

`r table_header("su_y_ptu")`
...
**Notes and special considerations:** Because this measure was introduced midway through the 3-year follow-up assessment, a proportion of participants did not receive the measure and appear as missing data. This measure was given at the 3-year and 5-year follow up assessments; it was then converted to a vaping marijuana specific measure (see Marijuana Vaping Expectancies).

**Key reference:** `r full_cite("torrealday2008")`

### Marijuana Vaping Expectancies {#su_y_mjvapeexp}

`r table_header("su_y_mjvapeexp")`

**Measure description:** Measures thoughts, feelings and beliefs about effects of vaping marijuana. This was adapted from the Vaping Expectancies measure described above.The questions are the same as those in Vaping Expectancies, but specific to marijuana.

**Notes and special considerations:** This measure started at the 7-year follow up assessment.

**Key references:** 

- `r full_cite("torrealday2008")`

### Vaping Motives {#su_y_vapemot}

`r table_header("su_y_vapemot")`

**Measure description:** Reasons for vaping, which may include vaping nicotine or marijuana. This inventory was created by a subgroup on the ABCD Substance Use workgroup, including Drs. Krista Lisdahl, Mary Heitzeg, Marsha Lopez, Susan Tapert, and Gaya Dowling. The instructions were modified from the Monitoring the Future Study 2020 interview and Tobacco Motive Inventory and items were modified from the Reasons for ENDS Use, PATH Study, Tobacco Motive Inventory with additional items created by the subgroup.
...
::: {.callout-caution collapse="true" title="Release notes: `su_y_tlfb`"}
**6.1** 

-   [**3 month score correction**](../release_notes/6_1.qmd#timeline-followback): All scores in the `su_y_tlfb` table using the "past 3 months" (`__3mo`) time frame were corrected to properly account for 90 days from the time of administration rather than the 60 used in 6.0 data.

**6.0**

-   [**Misc corrections**](../release_notes/6_0.qmd#tlfb-corrections): There were a few corrections that have been made ahead of the 6.0 release.
    -   Repeat use mis-scoring
    -   Occasions as a dose
    -   Estimate vs detailed use periods
    -   Max daily units
:::
...
- `r full_cite("cdc2025a")` 
- `r full_cite("nci2005")`
- `r full_cite("lisdahl2018")`
- `r full_cite("sobell1996")`
...
- `r full_cite("bartels2016")`
- `r full_cite("friese2012")`

### KSADS---Alcohol Use Disorder (Parent) {#su_p_ksads__aud}

`r table_header("su_p_ksads__aud")`
...
Parent KSADS module for Alcohol Use Disorder was not administered starting at Year 7.
...
::: {.callout-caution collapse="true" title="Release notes: KSADS items"}
**7.0** 

-   [**KSADS items**](../release_notes/7_0.qmd#ksads-items): The KSADS Alcohol Use Disorder (su_p_ksads__aud) item level data and symptom means have been included in the 7.0 Release. 

-   [**KSADS Diagnosis and Symptom Data**](../release_notes/7_0.qmd#ksads-diagnosis-and-symptom-data): The KSADS diagnosis and symptom score data were re-ingested and cleaned for the 7.0 release.
...
`r table_header("su_p_ksads__dud")`

**Measure description:** Parent reported on youth DSM-5 based symptoms and diagnoses (although not clinician administered; therefore, not official psychiatric diagnoses) of drug use disorder based on the responses to individual questions using the computer administered version of the Kiddie Schedule for Affective Disorders and Schizophrenia for School-Aged Children ([KSADS-COMP](https://www.ksadslogin.net/ksads-comp/aboutKC.aspx)).

Parent KSADS module for Drug Use Disorder was not administered starting at Year 7.
...
-   [**KSADS items**](../release_notes/7_0.qmd#ksads-items): The KSADS Drug Use Disorder (su_p_ksads__dud) item level data and symptom means have been included in the 7.0 Release. 
...
::: {.callout-warning collapse="true" title="Data consideration: Parental Rules for ENDS use" #data-ends}
Parental Rules for ENDS use was not collected at Year 4 for a portion of participants due to a branching logic error. That branching error was caught and corrected halfway through Year 4 data collection.
:::

**Key references:**

- `r full_cite("dishion2003")`
- `r full_cite("dishion2003a")`
- `r full_cite("jackson2015")`
- `r full_cite("jackson2014")`
