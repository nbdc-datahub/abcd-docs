...
-   [**Summary scores**](../release_notes/6_0.qmd#fitbit-summary-scores): Fitbit summary scores will not be released with the 6.0 data due to calculation errors.
-   [**File data errors**](../release_notes/6_0.qmd#fitbit-raw-data-files): Please note that the raw Fitbit data files being released as individual-level csv files in the file-based data contain some known issues.
:::
