...
::: {.callout-caution collapse="true" title="Release notes: `SEDA`"}
 **6.0**
 
- [**SEDA subtables**](../release_notes/6_0.qmd#school-information): In the 6.0 data release, we have subdivided the SEDA tables.
:::
...
- [**Incorrectly mapped variable names**](../release_notes/6_0.qmd#satellite-based-o3-measures): There was an error during curation of the `le_l_lo3` table, in which the new variable names for three average ozone variables (`le_l_03__addr1__03_mean__2016`, `le_l_03__addr2__03_mean__2016` and `le_l_03__addr2__03_mean__2016`) were incorrectly mapped to the old variable names. 
:::
...
**Key reference:** `r full_cite("finlay2020a")`
