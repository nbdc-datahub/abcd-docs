...
[Download table as a pdf](../../assets/files/documentation/non_imaging/6_0_le.pdf){style="display: block; text-align: right; margin-top: 4px;"}
...
[**SEDA subtables (6.0)**](../release_notes/6_0.qmd#school-information) In the 6.0 data release, we have subdivided the SEDA tables.
:::
...
[**Address collection (6.0)**](../release_notes/6_0.qmd#data-collection-process): The original address data collection processes in ABCD relied on a point-in-time capture of residential addresses rather than recording longitudinal residential history.
:::
