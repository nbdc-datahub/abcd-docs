...
[Download table as a pdf](../../assets/files/documentation/non_imaging/6_0_ph.pdf){style="display: block; text-align: right; margin-top: 4px;"}
...
[**New domain classification (6.0)**](../release_notes/6_0.qmd#sexual-behavior-orientation-and-communication): Variables related to sexual behavior, orientation, and communication are now available in the `Physical Health` domain, under the `Sex` subdomain.
:::
...
[**Known issues (6.0)**](../release_notes/6_0.qmd#neurocoginition-known-issues): There are some errors with the summary scores counting invalid inputs like 0, and there are some outliers in the data. 
:::
...
[**SDS summary score (6.0)**](../release_notes/6_0.qmd#sleep-disturbance-scale-for-children-sds-summary-scores): All summary scores were re-calculated for the 6.0 data release. However, SDS summary scores were not included in the development plan and were therefore not ready in time for this release.
:::
...
[**New domain classification (6.0)**](../release_notes/6_0.qmd#sexual-behavior-orientation-and-communication): In the 6.0 data release, variables related to sexual behavior, orientation and communication are available in the `Physical Health` domain, under the `Sex` subdomain.
:::
