...
[Download table as a pdf](../../assets/files/documentation/non_imaging/6_0_mh.pdf){style="display: block; text-align: right; margin-top: 4px;"}
...
[**BPM tables T-scores (6.0)**](../release_notes/6_0.qmd#brief-problem-monitor): 
...
[**Suicidality module (6.0)**](../release_notes/6_0.qmd#ksads-suicidality): There is some error in the past suicide data for Year 5 and beyond (update pending 6.1).
:::
...
[**ASR T-Scores (6.0)**](../release_notes/6_0.qmd#asr): The table `mh_p_asr` does not currently have t-scores available in the dataset due to not having a caregiver sex variable available in the correct structure to compute the score. This issue will be resolved in a future release.
:::
