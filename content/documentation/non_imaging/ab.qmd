...
-   [**Levels labelling error fixed**](../release_notes/6_1.qmd#household-income-scores-levels-labelling-error-fixed): A levels labeling error was identified in summary scores in 6.0 for the items `ab_g_dyn__cohort_income__hhold__3lvl` and `ab_g_dyn__cohort_income__hhold__6lvl`. The levels table has been corrected in the 6.1 patch release.
...
-   [**Levels labelling error**](../release_notes/6_0.qmd#household-income-scores-levels-labelling-error)
