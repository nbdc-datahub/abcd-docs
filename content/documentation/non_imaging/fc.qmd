...
[Download table as a pdf](../../assets/files/documentation/non_imaging/6_0_fc.pdf){style="display: block; text-align: right; margin-top: 4px;"}
...
[**Domain name (6.0)**](../release_notes/6_0.qmd#friends-family-community): This domain was previously referred to as 'Culture and Environment'.
:::
...
[**Peer Behavior Profile summary scores (6.0)**](../release_notes/6_0.qmd#peer-behavior-profile-pbp-summary-scores): The workgroup decided that Peer Behavior Profile (PBP) summary scores would not be included in this release, as the available items do not map clearly onto validated subscales.
::: 
...
[**Values Scale (6.0)**](../release_notes/6_0.qmd#values-scale-summary-scores): The Values Scale currently lacks a summary score for the *familism subscale*, which will be included in a future data release.
:::
...
[**Familism summary scores (6.0)**](../release_notes/6_0.qmd#values-scale-summary-scores): The Values Scale currently lacks a summary score for the *familism subscale*, which will be included in a future data release.
:::
