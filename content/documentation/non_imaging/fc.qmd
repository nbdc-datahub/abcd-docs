...
<!-- [Download table as a pdf](../../assets/files/documentation/non_imaging/6_1_fc.pdf){style="display: block; text-align: right; margin-top: 4px;"} -->

Read the below references to learn more about the Family, Friends, and Community (FC) domain (@zucker2018; @gonzalez2021).

- `r full_cite("zucker2018")`
- `r full_cite("gonzalez2021")`

::: {.callout-caution collapse="true" title="Release notes: `fc`"}
**7.0**

-   [**New FC tables**](../release_notes/7_0.qmd#new-fc-tables): There were new tables included in the 7.0 Data release: Acculturation Gap (`fc_y_ag`), Education & Vocation (`fc_y_ev`), UCLA Loneliness Scale (`fc_y_lone`).

-   [**New NAA summary score**](../release_notes/7_0.qmd#new-fc-tables): There is a new summary score `fc_y_naa_mean` for the Native-American Acculturation Scale (NAAS).

**6.0**

-   [**Domain name**](../release_notes/6_0.qmd#friends-family-community): This domain was previously referred to as 'Culture and Environment'.

:::

::: {#use-fc .callout-important collapse="true" title="Responsible use consideration: Friends, Family, & Community domain general"}
...
- `r full_cite("cardenas-iniguez2023")`
- `r full_cite("duncan2024")`
- `r full_cite("feldsteinewing2022")`
- `r full_cite("lett2022")`
- `r full_cite("white2023")`
:::
...
- `r full_cite("alegria2004")`
- `r full_cite("marin1987")`

## Acculturation Gap {#fc_y_ag}

`r table_header("fc_y_ag")`

**Measure description:** The Acculturation Gap Conflicts Inventory (AGCI; @basanez2014) measures the types of recurring conflicts that young people experience as part of the parent-child acculturation gap (i.e., discrepancies between the parents’ level of acculturation and that of their children). These seven items reflect the Preferred-Culture Conflicts subscale of the AGCI that relates to tensions over the cultural orientation choices of parents and young people. Items are rated on a 7-point Likert scale ranging from 1 = strongly disagree to 7 = strongly agree. The third item was revised slightly from the original version which was auto-populated based on the youth’s response to their cultural identity (i.e., original version “I feel uncomfortable because I have to choose between [CULTURAL IDENTITY] and non-[CULTURAL IDENTITY] ways of doing things” and current version “I feel uncomfortable because I have to choose between “American” ways of doing things and my parent’s ways of doing things”).

**Key reference:**

`r full_cite("basanez2014")`

## Activity Space {#fc_y_as}

`r table_header("fc_y_as")`
...
- `r full_cite("garnett2014")`
- `r full_cite("phinney1998")`

## Education & Vocation {#fc_y_ev}

`r table_header("fc_y_ev")`

**Measure description:** These items assess participants’ educational status, work experiences, and future educational and career expectations. The variables are not derived from a single validated scale but instead represent a structured set of self-reported indicators capturing multiple dimensions of adolescents’ educational and vocational trajectories.
Educational items assess (1) current school enrollment and type of school program, (2) highest level of completed schooling and highest grade completed, and (3) expected future educational attainment, including academic, vocational/technical, military, and graduate pathways.
Work and vocational items assess engagement in a range of experiences over the past 12 months, including paid employment, internships (paid and unpaid), volunteer or community service, and military-related activities. Additional items capture work intensity and duration (e.g., hours worked per week, months worked, number of concurrent roles), income (hourly earnings), and financial contribution to household expenses. Self-report items also assess career interests, including consideration of STEM-related occupations.
Occupational information is further classified using standardized job categories (e.g., management, healthcare, construction, education, and technical fields), with participants providing job titles within these domains. These classifications are aligned with the U.S. Bureau of Labor Statistics Standard Occupational Classification system, allowing for harmonization across studies.

::: {.callout-caution collapse="true" title="Release notes: `fc_y_ev`"}
**7.0**

-   [**School program level mislabeling**](../release_notes/7_0.qmd#youth-education-vocation-school-type-level-mislabeling): There is a level labeling issue for item `fc_y_ev__edu_002__v01` asking about the specific type of school program in which the youth is enrolled such that the label for response option `3` displays incorrectly.
::: 

## Family Environment Scale (PhenX) {#fc_y_fes}

`r table_header("fc_y_fes")`

**Measure description:** The youth responds to 2 subscales, Family Conflict and Family Cohesion, of the Family Environment Scale (FES) [@moos1994] The Family Conflict subscale consists of 9 items assessing the amount of openly expressed conflict among family members. The Family Cohesion subscale consists of 9 items assessing the degree of commitment, help, and support family members provide for one another. These subscales mirror those collected from the parent [Family Environment Scale (PhenX)](#fc_p_fes).

**Key reference:** `r full_cite("moos1994")`


## UCLA Loneliness Scale {#fc_y_lone}

`r table_header("fc_y_lone")`

**Measure description:** The University of California at Los Angeles (UCLA) Loneliness Scale (@russell1980) is a measure of a global or a general feeling of loneliness that is unidimensional in structure. The version used in ABCD represents a shortened 7-item version based on the work of @oshagan1992. Items are scored on a 4-point Likert scale (never = 0, rarely = 1, sometimes = 2, often = 3).

**Key references:**

-   `r full_cite("russell1980")`

-   `r full_cite("oshagan1992")`

-   `r full_cite("elphinstone2018")`

## Multigroup Ethnic Identity Measure (MEIM-R) {#fc_y_meim}

`r table_header("fc_y_meim")`
...
**Key reference:** `r full_cite("phinney2007")`

## Multidimensional Neglectful Behavior Scale {#fc_y_mnbs}

`r table_header("fc_y_mnbs")`
...
**Key reference:** `r full_cite("dubowitz2011")`

## Native-American Acculturation Scale (NAAS) {#fc_y_naa}

`r table_header("fc_y_naa")`
...
- `r full_cite("garrett2000")`
- `r full_cite("reynolds2012")`
- `r full_cite("white2023")`

## Neighborhood Safety/Crime Survey (PhenX) {#fc_y_nsc}

`r table_header("fc_y_nsc")`

**Measure description:** The youth items, derived from the PhenX Neighborhood Safety Protocol, evaluates self-reported perceptions of neighborhood conditions, rated on a 5-point Likert scale ranging from "strongly disagree (1)" "strongly agree (5)". The "neighborhood" is defined as "an area within about a 20-min walk (or about a mile) from your home."

**Key reference:** `r full_cite("mujahid2007")`

## Peer Behavior Profile {#fc_y_pbp}

`r table_header("fc_y_pbp")`
...
::: {.callout-caution collapse="true" title="Release notes: `fc_y_pbp`"}
**6.0**

-   [**Peer Behavior Profile summary scores**](../release_notes/6_0.qmd#peer-behavior-profile-pbp-summary-scores): The workgroup decided that Peer Behavior Profile (PBP) summary scores would not be included in this release, as the available items do not map clearly onto validated subscales.
::: 

**Key references:**

- `r full_cite("bingham1995")`
- `r full_cite("hirschi2002")`
- `r full_cite("jessor1977")`

## Pet Ownership {#fc_y_pet}

`r table_header("fc_y_pet")`
...
**Key reference:** `r full_cite("purewal2017")`

## Parental Monitoring {#fc_y_pm}

`r table_header("fc_y_pm")`
...
**Key reference:** `r full_cite("karoly2016")`

## Peer Network Health: Protective Scale {#fc_y_pnh}

`r table_header("fc_y_pnh")`
...
**Key reference:** `r full_cite("mason2015")`

## Prosocial Behavior (PhenX) {#fc_y_psb}

`r table_header("fc_y_psb")`
...
**Key reference:** `r full_cite("goodman2003")`

## Resistance to Peer Influence {#fc_y_rpi}

`r table_header("fc_y_rpi")`
...
**Key reference:** `r full_cite("steinberg2007")`

## School Attendance and Grades {#fc_y_sag}

`r table_header("fc_y_sag")`
...
**Key reference:** `r full_cite("zucker2018")`

## School Risk and Protective Factors (PhenX) {#fc_y_srpf}

`r table_header("fc_y_srpf")`
...
- `r full_cite("hamilton2011")`


## Values Scale {#fc_y_vs}

`r table_header("fc_y_vs")`
...
::: {.callout-caution collapse="true" title="Release notes: `fc_y_vs`"}

**6.1**

-   [**Values Scale Summary Scores**](../release_notes/6_1.qmd#values-scale-summary-scores): The `familism` subscale scores that were previously missing have been added to the `fc_y_vs` and `fc_p_vs` tables.

**6.0**

-   [**Values Scale**](../release_notes/6_0.qmd#values-scale-summary-scores)

:::

**Key reference:** `r full_cite("knight2010")`

## Wills Problem Solving Scale {#fc_y_wpss}

`r table_header("fc_y_wpss")`
...
**Key reference:** `r full_cite("wills2008")`

# Parent tables

## Acculturation Survey (PhenX) {#fc_p_aclt}

`r table_header("fc_p_aclt")`
...
- `r full_cite("moos1994")`
- `r full_cite("sanford1999")`

## Home Short Form {#fc_p_hsf}

`r table_header("fc_p_hsf")`
...
- `r full_cite("bradley1984")`
- `r full_cite("bradley2001")`
- `r full_cite("yamaoka2019")`

## Multigroup Ethnic Identity-Revised Survey {#fc_p_meim}

`r table_header("fc_p_meim")`
...
## Neighborhood Collective Efficacy (PhenX) {#fc_p_nce}

`r table_header("fc_p_nce")`
...
**Key reference:** `r full_cite("nacjd1994")`

## Neighborhood Safety/Crime Survey (PhenX) {#fc_p_nsc}

`r table_header("fc_p_nsc")`
...
- `r full_cite("echeverria2004")`
- `r full_cite("mujahid2007")`

## Parent Knowledge Scale {#fc_p_pk}

`r table_header("fc_p_pk")`
...
**Key reference:** `r full_cite("stattin2000")`

## Prosocial Behavior (PhenX) {#fc_p_psb}

`r table_header("fc_p_psb")`
...
::: {.callout-caution collapse="true" title="Release notes: `fc_p_vs`"}
**6.1** 
...
- `r full_cite("knight2010")`
- `r full_cite("phinney2007")`
