...
[Download table as a pdf](../../assets/files/documentation/non_imaging/6_0_nc.pdf){style="display: block; text-align: right; margin-top: 4px;"}
...
[**Known issues (6.0)**](../release_notes/6_0.qmd#neurocoginition-known-issues): Some data are incorrectly entered in percentage form and some data contain zero, which might seem implausible. 
:::
...
[**Known issues (6.0)**](../release_notes/6_0.qmd#neurocoginition-known-issues): There are some potential outliers in the `nc_y_nihtb__readr__uncor_score` data.  
:::
