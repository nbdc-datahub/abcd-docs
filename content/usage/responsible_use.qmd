...
# Considerations in data documentation

To facilitate responsible data use, considerations have been added to variables in the data dictionary and are linked to sections of the data documentation website to provide additional information for data users (e.g. information about data quality issues and guidance on appropriate use of data). These considerations, which may apply at the variable or table level, are included directly in the data dictionary as hyperlinks to the documentation website. 

In [DEAP](https://abcd.deapscience.com) and the [NBDC Data Hub](https://nbdc-datashare.lassoinformatics.com) these considerations are indicated by icons: <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" aria-hidden="true"> <path d="M12 5.99 19.53 19H4.47zM2.74 18c-.77 1.33.19 3 1.73 3h15.06c1.54 0 2.5-1.67 1.73-3L13.73 4.99c-.77-1.33-2.69-1.33-3.46 0zM11 11v2c0 .55.45 1 1 1s1-.45 1-1v-2c0-.55-.45-1-1-1s-1 .45-1 1m0 5h2v2h-2z" fill="rgb(255, 191, 0)"></path></svg> (Data) and  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" aria-hidden="true"> <path d="M12 7c.55 0 1 .45 1 1v4c0 .55-.45 1-1 1s-1-.45-1-1V8c0-.55.45-1 1-1m-.01-5C6.47 2 2 6.48 2 12s4.47 10 9.99 10C17.52 22 22 17.52 22 12S17.52 2 11.99 2M12 20c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8m1-3h-2v-2h2z" fill="rgb(249, 56, 49)"></path></svg> (Responsible use). In DEAP/NBDC Data Hub the consideration icons are hyperlinked back to the consideration on this data documentation website. 

Data users would be served to:

1.  Review the data considerations for any variable that you will be downloading and/or using by clicking the link and reviewing the consideration associated with that variable
2.  Review any resources included with the considerations and consider guidelines

There are two types of considerations, data & responsible use. Considerations will be displayed in callout boxes like shown below:

::: {.callout-warning title="Data consideration" #ex-data-warn}
The purpose of this consideration is to aid in transparency and refers to technical data issues (e.g., data quality issues, information about how variables are constructed, instructions on how to calculate or analyze specific variables, code if necessary).
:::

::: {.callout-important title="Responsible use consideration" #ex-resp-use-warn}
The purpose of this consideration is to provide guidance for responsible data use, interpretation, and communication to enhance rigor and reproducibility. This also includes conceptual considerations (e.g., bias due to attrition or non-response).
:::
