...
>The ABCD data repository grows and changes over time. The ABCD data used in this report came from NBDC Digital Object Identifier (DOI). DOIs can be found at [https://www.nbdc-datahub.org/abcd-study](https://www.nbdc-datahub.org/abcd-study).
