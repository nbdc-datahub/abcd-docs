...
To cite the current version (_{{< var version_current >}}_), visit the most recent release on [Zenodo](https://doi.org/10.5281/zenodo.15800724). The appropriate citation with the DOI for the latest version is listed in the citation box on the right side of the page—simply copy and paste it into your references.
