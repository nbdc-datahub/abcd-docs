...
For ABCD study data, NIDA requires a threshold minimum n of 10 in public reporting of data, including scientific publications and presentations. Their recommendations can be found here. {{< downloadthis ../assets/files/NIDA_recommendations.docx
dname="NIDA Recommendations" label="NIDA_recommendations.docx" type="light" >}}
:::
