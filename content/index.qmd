...
| [<span class="pill_blue_large">Tools</span>](tools/tools.qmd) | Tools and platforms for data exploration and analysis: [DEAP](https://abcd.deapscience.com/), [Lasso](https://nbdc-datashare.lassoinformatics.com/), [R packages](tools/r_packages.qmd). |
