...
window.onload = function() {
  ...
  for (var i = 0; i < dropdownItems.length; i++) {
    ...
    dropdownItems[i].addEventListener('click', function(event) {
      ...
      console.log('DEBUG: href clicked:', href);
      ...
      checkPathExists(newUrl)
        .then(exists => {
          if (!exists) {
            ...
            console.log('DEBUG: About to navigate to:', newUrl);
            console.log('DEBUG: Current location before navigation:', window.location.href);
            
            // Add event listener to track what actually happens
            const originalPushState = history.pushState;
            const originalReplaceState = history.replaceState;
            
            history.pushState = function(...args) {
              console.log('DEBUG: history.pushState called with:', args);
              return originalPushState.apply(this, args);
            };
            
            history.replaceState = function(...args) {
              console.log('DEBUG: history.replaceState called with:', args);
            ...
            // Try using replace instead of href assignment
            console.log('DEBUG: Executing navigation to:', newUrl);
